<template>
    <header class="header">
        ...
        <div class="organisation">Федерация спортивного ориентирования</div>
        <div class="user_menu">
            <!--<div class="header_divider"></div>-->
            <img src="@/assets/images/profile_icon.png" class="user_icon inl_block" />
            <div class="inl_block">Куприенко Д.В.</div>
            <InputIcon class="pi pi-angle-down arrow inl_block" />
            <div class="menu">
...
.menu {
    ...
    & a {
        ...
        &:hover {
            background-color: var(--primary-light-ligh-gray);
        }
    }
}
